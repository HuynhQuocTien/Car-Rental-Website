            ...
            <form class="js-validation-reminder">
              <div class="mb-4">
                <div class="input-group input-group-lg">
                  <input type="text" class="form-control" id="sentOTP" name="sentOTP" placeholder="Email">
              ...
              <div class="text-center mb-4">
                <button type="submit" class="btn btn-hero btn-primary" id="btn-reminder">
                  <i class="fa fa-fw fa-reply opacity-50 me-1"></i> Send OTP
                </button>
              </div>
            </form>
            <!-- END Reminder Form -->
