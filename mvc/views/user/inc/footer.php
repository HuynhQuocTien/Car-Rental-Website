            ...
            <div class="content py-4">
                ...
                <div class="row items-push fs-sm border-bottom pt-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <form class="mb-4" action="db_booking.html" method="POST">
                            <div class="input-group">
                                <input type="email" class="form-control" id="dm-subscribe-email"
                                    name="dm-subscribe-email" placeholder="Email Address..">
                ...
                <div class="row fs-sm pt-4">
                    ...
                    <div class="col-sm-6 order-sm-1 text-center text-sm-start">
                        <a class="fw-semibold" href="https://pixelcave.com/products/dashmix" target="_blank">Dashmix
