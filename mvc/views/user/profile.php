                  ...
                  <div class="col-xl-6 order-xl-0">
                    <form id="profileForm" action="be_pages_generic_profile_v2_edit.html" method="POST" enctype="multipart/form-data" onsubmit="return false;">
                      ...
                      <div class="mb-4">
                        ...
                        <input type="text" class="form-control" id="dm-profile-edit-name" name="dm-profile-edit-name" placeholder="Enter your name.." value="<?php echo $data["UserProfile"]["CustomerDetail"]["FullName"]; ?>">
                      </div>
                      <div class="mb-4">
                          ...
                          <div class="col-auto">
                            <div>
                              ...
                              <input type="radio" class="form-check-input" name="sex" value="Male" 
                                <?php if ($data["UserProfile"]["CustomerDetail"]["Sex"] == 0) echo "checked"; ?>>
                            </div>
                          </div>
                          <div class="col-auto">
                            <div>
                              ...
                              <input type="radio" class="form-check-input" name="sex" value="Female" 
                                <?php if ($data["UserProfile"]["CustomerDetail"]["Sex"] == 1) echo "checked"; ?>>
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="col-xl-6 order-xl-0">
                    <form action="be_pages_generic_profile_v2_edit.html" method="POST" onsubmit="return false;">
                      <div class="mb-4">
                        ...
                        value="<?php echo $data["UserProfile"]["CustomerDetail"]["TotalAmount"] ?>"
                        readonly
                        >
                      </div>
                      <div class="row mb-4">
                        <div class="col-6">
                          ...
                          value="<?php echo $data["UserProfile"]["CustomerDetail"]["TotalOrdered"] ?>"
                          readonly
                          >
                        </div>
                        <div class="col-6">
                          ...
                          value="<?php echo $data["UserProfile"]["CustomerDetail"]["TotalFine"] ?>"
                          readonly
                          >
                        </div>
                      </div>
